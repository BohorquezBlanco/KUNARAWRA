...
<body class="bg-light">
    <div class="containe-xxl position-relative bg-white d-flex p-0">
        ...
        <?php echo form_open_multipart('Pregunta/modificarbdExG'); ?>
          <div class="row bg-light">
            <h1 class="text-center p-4">MODIFICAR EXAMEN</h1>
<!--######################## PARA EL EXAMEN ######################################-->
<input type="hidden" name="idUsuario" value="<?php echo $this->session->userdata('idusuario'); ?>">

            <?php foreach($examen->result() as $row)
             { ?>
            ...
            <div class="col-6 p-3">
              ...
              <input type="text"  id="tituloEx" name="tituloEx" class="form-control" placeholder="Escribe un titulo" value="<?php echo $row->nombreExamen;?>" required/>
              <input type="text"  id="idExamen" name="idExamen" class="form-control" placeholder="Escribe un titulo" value="<?php echo $row->idExamen;?>" required/>

            </div>
            <div class="col-6 p-3">
            <label for="">Descripcion</label>
              <input type="text"  id="DescripEx" name="DescripEx" class="form-control" placeholder="Escribe una descripcion breve" value="<?php echo $row->descripcion;?>" required/>
            </div>

            <div class="col-4">
              <select id="dificultad" name="dificultad" class="form-control form-select form-select-lg" required>
                    <option value="<?php echo $row->dificultad;?>">Dificultad: <?php echo $row->dificultad;?></option>
       ...
       <?php  foreach($preguntaE -> result() as $row){
...
<!--######################## FIN PARA EL EXAMEN ######################################-->
          ...
          <div class="table-responsive bg-white border caja3" id="carrito">
                ...
                <tbody>
                  ...
                  <?php $indice=1;
                     foreach($preguntaEx->result() as $row){?>
                      <tr>
                          <td></td>
                          ...
                          <td>sdf</td>
                          <td>20</td>
                          <input type="hidden" name="idP[]" value="<?php echo $row->idPregunta; ?>">
                          <td>
                            <a href="#" class="borrar-curso btn btn-primary" data-id="20">X</a>
                          </td>
                      </tr>
                  <?php $indice++;}?>
                  <!-- AQUI ENTRA EL CLON-->
