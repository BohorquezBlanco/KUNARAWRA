                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="nombrecarrera" class="form-control" id="name" placeholder="Your Name">
                                <label for="name" >Escribe la carrera</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="descripcioncarrera" class="form-control" id="email" placeholder="Your Email">
