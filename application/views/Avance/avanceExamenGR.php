...
<body class="container ">
    ...
    <?php echo form_open_multipart('inscripcion/calificacionExGR');?>
        <div class="row justify-content-center">
            ...
            ?>
                ...
                ?>
                    ...
                    <input type="text" name="idCalificacion" value=" <?php echo $row->idCalificacion; ?>"><!--CON ESTO SABREMOS CUANTAS VECES SE RECORRERA EL CICLO FOR ---->
