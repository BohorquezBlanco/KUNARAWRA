...
<body class="container ">
        ...
        <div class="row justify-content-center">
            ...
            ?>
                ...
                <div class="col-lg-8">
                    ...
                    <input type="text" name="correcta[]" value="<?php echo $row->correcta.$indice;?>" > <!--aqui muestra la pregunta correcta-->
   ...
   <?php
     ...
     <div class="container">
        <div class=" row justify-content-center">
            <div class="col-8 p-2">
                <input type="text" name="contador" value=" <?php echo $indice; ?>"><!--CON ESTO SABREMOS CUANTAS VECES SE RECORRERA EL CICLO FOR ---->
