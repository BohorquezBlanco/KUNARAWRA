                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="nombreleccion" class="form-control" id="name" placeholder="Your Name">
                                <label for="name" >Escribe el nombre de la leccion</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="descripcionleccion" class="form-control" id="email" placeholder="Your Email">
                                <label for="name">Escribe su descripcion</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="urlVideo" class="form-control" id="email" placeholder="Your Email">
