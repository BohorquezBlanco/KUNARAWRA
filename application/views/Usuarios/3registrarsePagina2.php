    ...
    <div class="container-xxl py-5">
        ...
        <div class="row g-4 align-items-center justify-content-center">
            <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                ...
                <?php echo form_open_multipart('usuarios/agregarbd2'); //apertura de formulario llegando al metodo agregarbase de datos?>
                <form class="row g-3 needs-validation" novalidate>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input style="text-transform:uppercase;" type="text" name="Nombre" class="form-control" id="email" placeholder="Your Email" required>
                                <label for="validationCustom09" >Escribe tu nombre</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input style="text-transform:uppercase;" type="text" name="PrimerApellido" class="form-control" id="email" placeholder="Your Email" required>
                                <label for="validationCustom09">Escribe tu primer apellido</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input style="text-transform:uppercase;" type="text" name="SegundoApellido" class="form-control" id="email" placeholder="Your Email" required>
