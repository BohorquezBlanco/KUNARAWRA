    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="<?php echo base_url(); ?>index.php/usuarios/UsuariosPanel" class="nav-item nav-link active">USUARIOS</a>
                <a href="<?php echo base_url(); ?>index.php/usuarios/UsuariosPanelA" class="nav-item nav-link">ADMINISTRADORES</a>
